...
IMG ?= registry.k-paas.org/kpaas/nhn-controller:latest
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kube-controller02-builder
	$(CONTAINER_TOOL) buildx use kube-controller02-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm kube-controller02-builder
	rm Dockerfile.cross
